...
function saveGeminiSettings() {
  ...
  // لا تمسح الموديل الحالي — استخدم testGeminiKey للتحقق وتحديده
  if (!key) {
    localStorage.removeItem('athar_gemini_model');
    localStorage.removeItem('madar_gemini_model');
  }
  showToast(key ? 'تم حفظ مفتاح Gemini — اضغط "اختبار المفتاح" للتحقق 🧠' : 'تم مسح المفتاح والرجوع للوضع الافتراضي');
}
